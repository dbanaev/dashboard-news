 ...
 * Туториал http://true-coder.ru/php/php-klass-dlya-resajza-izobrazhenij.html
 *
...
class acResizeImage
{
     ...
     * @param $dontIncrease bool	Не увеличивать изображение, если оригинал меньше
     * @return object 			Текущий объект класса
     */
    function resize($width = false, $height = false, $dontIncrease = false)
    {

        //if ($width < $this->width && $height < $this->height && $dontIncrease) {
        /**
